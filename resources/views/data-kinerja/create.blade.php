<x-dashboard-layout>
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Tambah Data Kinerja</h1>
        <p class="text-gray-600 mt-1">Input data kinerja baru</p>
    </div>

    <div class="bg-white rounded-lg shadow">
        <div class="p-6">
            <form method="POST" action="{{ route('data-kinerja.store') }}">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <select name="indikator_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                        ...
                        @foreach($indikators as $indikator)
                            <option value="{{ $indikator->indikator_id }}" {{ old('indikator_id') == $indikator->indikator_id ? 'selected' : '' }}>
                ...
                <div class="mb-6">
                    ...
                    <select name="kriteria_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                        ...
                        @foreach($kriterias as $kriteria)
                            <option value="{{ $kriteria->kriteria_id }}" {{ old('kriteria_id') == $kriteria->kriteria_id ? 'selected' : '' }}>
                ...
                <div class="mb-6">
                    ...
                    <input type="number" step="0.01" name="capaian" value="{{ old('capaian') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                    @error('capaian')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="url" name="bukti_file" value="{{ old('bukti_file') }}" placeholder="https://drive.google.com/..." class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
