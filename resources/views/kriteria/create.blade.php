<x-dashboard-layout>
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">Buat kriteria penilaian baru</p>
    </div>
        ...
        <div class="p-6">
            <form method="POST" action="{{ route('kriteria.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nama_kriteria" value="{{ old('nama_kriteria') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                    @error('nama_kriteria')
                ...
                <div class="mb-6">
                    ...
                    <input type="number" step="0.01" name="bobot" value="{{ old('bobot') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                    @error('bobot')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
