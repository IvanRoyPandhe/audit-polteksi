<x-dashboard-layout>
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Tambah Tindak Lanjut</h1>
        <p class="text-gray-600 mt-1">Buat rencana tindak lanjut</p>
    </div>
        ...
        <div class="p-6">
            <form method="POST" action="{{ route('tindak-lanjut.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <select name="temuan_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                        ...
                        @foreach($temuans as $temuan)
                            <option value="{{ $temuan->temuan_id }}" {{ old('temuan_id') == $temuan->temuan_id ? 'selected' : '' }}>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="rencana_perbaikan" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>{{ old('rencana_perbaikan') }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <input type="date" name="tanggal_target" value="{{ old('tanggal_target') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                ...
                <div class="mb-6">
                    ...
                    <select name="status_tindak" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                        ...
                        <option value="Direncanakan" {{ old('status_tindak') == 'Direncanakan' ? 'selected' : '' }}>Direncanakan</option>
                        <option value="Berlangsung" {{ old('status_tindak') == 'Berlangsung' ? 'selected' : '' }}>Berlangsung</option>
                        <option value="Selesai" {{ old('status_tindak') == 'Selesai' ? 'selected' : '' }}>Selesai</option>
                    </select>
                    @error('status_tindak')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-6">
                    ...
                    <input type="date" name="tanggal_selesai" value="{{ old('tanggal_selesai') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
